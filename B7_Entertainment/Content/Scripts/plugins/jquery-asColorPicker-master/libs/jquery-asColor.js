! function (e, t, a, r) {
    ...
    function n(e) {
        return 6 === e.length && e[0] === e[1] && e[2] === e[3] && e[4] === e[5] ? e[0] + e[2] + e[4] : e
    }
    ...
    var u, l, h, d = (l = "[\\s|\\(]+(" + (u = "(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)") + ")[,|\\s]+(" + u + ")[,|\\s]+(" + u + ")\\s*\\)", h = "[\\s|\\(]+(" + u + ")[,|\\s]+(" + u + ")[,|\\s]+(" + u + ")[,|\\s]+(" + u + ")\\s*\\)", {
        RGB: {
        ...
        c = a.asColor = function (e, t) {
            "object" == typeof e && void 0 === t && (t = e, e = r), "string" == typeof t && (t = {
                format: t
            }), this.options = a.extend(!0, {}, c.defaults, t), this.value = {
                r: 0,
                g: 0,
                b: 0,
                h: 0,
                ...
                v: 0,
                a: 1
            }, this._format = !1, this._matchFormat = "HEX", this._valid = !0, this.init(e)
        };
    c.prototype = {
        constructor: c,
        init: function (e) {
            ...
            if ("string" == typeof e) {
                ...
                for (var i in d)
                    if (null != (n = d[i].match.exec(e)) && (r = d[i].parse(n))) {
                        this.set(r), "TRANSPARENT" === i && (i = "HEX"), this._matchFormat = i, !0 === t && this.format(i);
                        break
                    }
            } else "object" == typeof e && this.set(e)
        },
        format: function (e) {
            if ("string" == typeof e && (e = e.toUpperCase()) && void 0 !== d[e]) this._format = "TRANSPARENT" !== e ? e : "HEX";
            else {
        ...
        to: function (e) {
            return "string" == typeof e && (e = e.toUpperCase()) && void 0 !== d[e] ? d[e].to(this.value, this) : this.toString()
        },
        toString: function () {
            var e, t = this.value;
            ...
            if (e = !1 === this._format ? this._matchFormat : this._format, this.options.reduceAlpha && 1 === t.a) switch (e) {
                case "RGBA":
                    e = "RGB";
                    break;
                case "HSLA":
            ...
            return 1 !== t.a && "RGBA" !== e && "HSLA" !== e && this.options.alphaConvert && ("string" == typeof this.options.alphaConvert && (e = this.options.alphaConvert), void 0 !== this.options.alphaConvert[e] && (e = this.options.alphaConvert[e])), d[e].to(t, this)
        },
        get: function () {
            return this.value
        },
        set: function (e) {
            ...
            var t, a, r = 0,
                n = 0;
            for (var i in e) - 1 !== "hsv".indexOf(i) ? (n++ , this.value[i] = e[i]) : -1 !== "rgb".indexOf(i) ? (r++ , this.value[i] = e[i]) : "a" === i && (this.value.a = e.a);
            r > n ? (t = c.RGBtoHSV(this.value), 0 === this.value.r && 0 === this.value.g && 0 === this.value.b || (this.value.h = t.h), this.value.s = t.s, this.value.v = t.v) : n > r && (a = c.HSVtoRGB(this.value), this.value.r = a.r, this.value.g = a.g, this.value.b = a.b)
        }
    }, c.HSLToRGB = function (e) {
        var t, a, r, n = e.h / 360,
            i = e.s,
            o = e.l;
        return t = 2 * o - (a = o <= .5 ? o * (i + 1) : o + i - o * i), r = {
            r: c.hueToRGB(t, a, n + 1 / 3),
            g: c.hueToRGB(t, a, n),
            b: c.hueToRGB(t, a, n - 1 / 3)
        }, void 0 !== e.a && (r.a = e.a), 0 === e.l && (r.h = e.h), r
    }, c.hueToRGB = function (e, t, a) {
        var r;
        return a < 0 ? a += 1 : a > 1 && (a -= 1), r = 6 * a < 1 ? e + (t - e) * a * 6 : 2 * a < 1 ? t : 3 * a < 2 ? e + (t - e) * (2 / 3 - a) * 6 : e, Math.round(255 * r)
        ...
        var t, a, r = e.r / 255,
            ...
            u = f + o,
            l = .5 * u;
        return t = o === f ? 0 : r === f ? 60 * (n - i) / s + 360 : n === f ? 60 * (i - r) / s + 120 : 60 * (r - n) / s + 240, a = 0 === s ? 0 : l <= .5 ? s / u : s / (2 - u), {
            h: Math.round(t) % 360,
            s: a,
            l: l
        }
        ...
        var t, a, r, n = e.h % 360 / 60,
            i = e.s,
            o = e.v,
            f = o * i,
            s = f * (1 - Math.abs(n % 2 - 1));
        return t = a = r = o - f, t += [f, s, 0, 0, s, f][n = ~~n], a += [s, f, f, s, 0, 0][n], r += [0, 0, s, f, f, s][n], {
            r: Math.round(255 * t),
            g: Math.round(255 * a),
            b: Math.round(255 * r)
        }
        ...
        var t;
        return 0 === e.indexOf("#") && (e = e.substr(1)), 3 === e.length && (e = (t = e) ? (3 === t.length && (t = t[0] + t[0] + t[1] + t[1] + t[2] + t[2]), 6 === t.length ? t : null) : null), {
            r: i(e.substr(0, 2)),
            g: i(e.substr(2, 2)),
            b: i(e.substr(4, 2))
        }
        ...
        var t = c.RGBToHEX(e);
        return 0 === t.indexOf("#") && (t = t.substr(1)), t = n(t), !!c.hexNames.hasOwnProperty(t) && c.hexNames[t]
